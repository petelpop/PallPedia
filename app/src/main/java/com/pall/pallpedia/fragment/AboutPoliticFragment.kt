...
import com.pall.pallpedia.databinding.FragmentAboutPoliticBinding
import com.pall.pallpedia.databinding.FragmentCommonBinding

class AboutPoliticFragment : Fragment() {
    private var _binding : FragmentAboutPoliticBinding? = null
    private val binding get() = _binding as FragmentAboutPoliticBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAboutPoliticBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getPoliticNews()
        viewModel.commonNews.observe(viewLifecycleOwner) {
            val data = it.articles
            Log.i("AboutPoliticFragment", "onResponse: $it ")
            binding.rvAboutPolitic.apply {
